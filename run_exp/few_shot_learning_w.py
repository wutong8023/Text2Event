                    ...
                    for no_module in [False]:
                        ...
                        for model in ["t5-base"]:
                            for shot in [1, 2, 5, 10, 15]:
                                for data in [f"oneie/wikievents/{str(shot)}_shot"]:
                                    target_output_dir = f"models/fslw_{tuning_type}_{no_module}{is_knowledge}_len{prefix_len}_shot{shot}_{data.split('/')[1]}_{current_time}"
